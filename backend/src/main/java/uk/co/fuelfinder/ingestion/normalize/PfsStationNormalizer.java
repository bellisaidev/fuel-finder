...
public class PfsStationNormalizer {
    ...
    public NormalizedStation normalize(PfsStationDto dto) {
        ...
        return NormalizedStation.builder()
                ...
                .address(location != null ? trimToNull(location.addressLine1()) : null)
                .city(location != null ? trimToNull(location.city()) : null)
                .county(location != null ? trimToNull(location.county()) : null)
                .country(location != null ? trimToNull(location.country()) : null)
                .postcode(location != null ? trimToNull(location.postcode()) : null)
